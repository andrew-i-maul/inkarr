...
namespace NzbDrone.Core.Parser.Model
{
    public class ParsedTrackInfo
    {
        ...
        public string VolumeTitle => Volumes.FirstOrDefault();
        ...
        public string VolumeMBId { get; set; }
        ...
        public override string ToString()
        {
            ...
            return string.Format("{0} - {1} - {2}:{3} {4}: {5}", Volumes.ConcatToString(" & "), IssueTitle, DiscNumber, trackString, Title, Quality);
        }
    }
}
