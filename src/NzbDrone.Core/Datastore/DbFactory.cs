...
namespace NzbDrone.Core.Datastore
{
    ...
    public class DbFactory : IDbFactory
    {
                ...
                if (e.InnerException is SocketException)
                {
                    ...
                    while (true)
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            throw new InkarrStartupException(ex, "Error creating main database");
                        }
                    }
                }
                else
                {
                    throw new InkarrStartupException(e, "Error creating main database");
                }
            }
            catch (Exception e)
            {
        ...
        private void CreateLog(string connectionString, MigrationContext migrationContext, DatabaseType databaseType)
        {
            ...
            {
                throw new InkarrStartupException(e, "Error creating log database");
            }
        }
    }
}
