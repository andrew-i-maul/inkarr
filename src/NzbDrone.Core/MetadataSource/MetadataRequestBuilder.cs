...
namespace NzbDrone.Core.MetadataSource
{
    ...
    public class MetadataRequestBuilder : IMetadataRequestBuilder
    {
        ...
        private readonly IInkarrCloudRequestBuilder _defaultRequestFactory;

        public MetadataRequestBuilder(IConfigService configService, IInkarrCloudRequestBuilder defaultRequestBuilder)
        {
