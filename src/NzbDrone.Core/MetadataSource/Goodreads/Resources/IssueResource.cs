...
namespace NzbDrone.Core.MetadataSource.Goodreads
{
    ...
    public sealed class IssueResource : GoodreadsResource
    {
        ...
        /// <summary>
        /// Signifies if this is an eIssue or not.
        /// </summary>
        public bool IsEissue { get; private set; }
        ...
        /// <summary>
        /// The list of volumes that worked on this issue.
        /// </summary>
        public IReadOnlyList<VolumeSummaryResource> Volumes { get; private set; }
        ...
        /// </summary>
        public IReadOnlyList<IssueSummaryResource> SimilarIssues { get; private set; }
        ...
        public override void Parse(XElement element)
        {
            ...
            IsEissue = element.ElementAsBool("is_eissue");
            ...
            Volumes = element.ParseChildren<VolumeSummaryResource>("volumes", "volume");
            SimilarIssues = element.ParseChildren<IssueSummaryResource>("similar_issues", "issue");

            var issueLinks = element.ParseChildren<IssueLinkResource>("issue_links", "issue_link");
            if (issueLinks != null)
            {
                issueLinks.ForEach(x => x.FixIssueLink(Id));
            ...
            if (buyLinks != null)
            {
                buyLinks.ForEach(x => x.FixIssueLink(Id));
                BuyLinks = buyLinks;
            }
