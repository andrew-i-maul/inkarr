...
namespace NzbDrone.Core.MetadataSource.Goodreads
{
    ...
    /// very brief information about an Volume instead of their entire profile.
    /// </summary>
    [DebuggerDisplay("{DebuggerDisplay,nq}")]
    public sealed class VolumeSummaryResource : GoodreadsResource
    {
        ...
        /// <summary>
        /// The image of this volume, regular size.
        /// </summary>
        public string ImageUrl { get; private set; }

        /// <summary>
        /// The image of this volume, small size.
        /// </summary>
        public string SmallImageUrl { get; private set; }

        /// <summary>
        /// The link to the Goodreads page for this volume.
        /// </summary>
        public string Link { get; private set; }

        /// <summary>
        /// The average rating for all of this volume's issues.
        /// </summary>
        public decimal? AverageRating { get; private set; }

        /// <summary>
        /// The total count of all ratings of this volume's issues.
        /// </summary>
        public int? RatingsCount { get; private set; }

        /// <summary>
        /// The total count of all the text reviews of this volume's issues.
        /// </summary>
