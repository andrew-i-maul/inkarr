...
namespace NzbDrone.Core.Download.Clients.Transmission
{
    ...
    public class TransmissionSettings : IProviderConfig
    {
        ...
        [FieldDefinition(6, Label = "Category", Type = FieldType.Textbox, HelpText = "Adding a category specific to Inkarr avoids conflicts with unrelated non-Inkarr downloads. Using a category is optional, but strongly recommended.. Creates a [category] subdirectory in the output directory.")]
