...
namespace NzbDrone.Core.DecisionEngine
{
    public class DownloadDecisionComparer : IComparer<DownloadDecision>
    {
        ...
        private int CompareQuality(DownloadDecision x, DownloadDecision y)
        {
            ...
            {
                return CompareBy(x.RemoteIssue, y.RemoteIssue, remoteIssue => remoteIssue.Volume.QualityProfile.Value.GetIndex(remoteIssue.ParsedIssueInfo.Quality.Quality));
            }

            return CompareAll(CompareBy(x.RemoteIssue, y.RemoteIssue, remoteIssue => remoteIssue.Volume.QualityProfile.Value.GetIndex(remoteIssue.ParsedIssueInfo.Quality.Quality)),
        ...
        private int CompareProtocol(DownloadDecision x, DownloadDecision y)
        {
            ...
            {
                var delayProfile = _delayProfileService.BestForTags(remoteIssue.Volume.Tags);
