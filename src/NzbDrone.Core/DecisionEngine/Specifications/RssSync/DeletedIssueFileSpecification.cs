...
{
    public class DeletedIssueFileSpecification : IDecisionEngineSpecification
    {
        ...
        public DeletedIssueFileSpecification(IDiskProvider diskProvider,
        ...
        public virtual Decision IsSatisfiedBy(RemoteIssue subject, SearchCriteriaBase searchCriteria)
        {
            ...
            {
                _logger.Debug("Skipping deleted issuefile check during search");
                return Decision.Accept();
            }
            ...
            var missingTrackFiles = subject.Issues
                                             ...
                                             .DistinctBy(v => v.Id)
                                             .Where(v => IsTrackFileMissing(subject.Volume, v))
                                             .ToArray();
        ...
        private bool IsTrackFileMissing(Volume volume, IssueFile issueFile)
        {
            return !_diskProvider.FileExists(issueFile.Path);
        }
    }
}
