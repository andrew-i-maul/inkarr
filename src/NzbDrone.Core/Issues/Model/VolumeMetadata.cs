...
{
    public class VolumeMetadata : Entity<VolumeMetadata>
    {
        ...
        {
            return string.Format("[{0}][{1}]", ForeignVolumeId, Name.NullSafe());
        }

        public override void UseMetadataFrom(VolumeMetadata other)
        {
