...
namespace NzbDrone.Core.Indexers.Gazelle
{
    ...
    public class GazelleSettings : ITorrentIndexerSettings
    {
        ...
        [FieldDefinition(4, Type = FieldType.Number, Label = "Early Download Limit", Unit = "days", HelpText = "Time before release date Inkarr will download from this indexer, empty is no limit", Advanced = true)]
