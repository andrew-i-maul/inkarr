...
namespace NzbDrone.Core.Notifications.CustomScript
{
    public class CustomScript : NotificationBase<CustomScriptSettings>
    {
        ...
        public override void OnReleaseImport(BookDownloadMessage message)
        {
            ...
            {
                environmentVariables.Add("Inkarr_DeletedPaths", string.Join("|", message.OldFiles.Select(e => e.Path)));
                environmentVariables.Add("Inkarr_DeletedDateAdded", string.Join("|", message.OldFiles.Select(e => e.DateAdded)));
            }
        ...
        public override void OnHealthIssue(HealthCheck.HealthCheck healthCheck)
        {
            ...
            environmentVariables.Add("Inkarr_EventType", "HealthIssue");
            environmentVariables.Add("Inkarr_Health_Issue_Level", Enum.GetName(typeof(HealthCheckResult), healthCheck.Type));
            environmentVariables.Add("Inkarr_Health_Issue_Message", healthCheck.Message);
            environmentVariables.Add("Inkarr_Health_Issue_Type", healthCheck.Source.Name);
            environmentVariables.Add("Inkarr_Health_Issue_Wiki", healthCheck.WikiUrl.ToString() ?? string.Empty);
        ...
        public override void OnApplicationUpdate(ApplicationUpdateMessage updateMessage)
        {
            ...
            environmentVariables.Add("Inkarr_EventType", "ApplicationUpdate");
            environmentVariables.Add("Inkarr_Update_Message", updateMessage.Message);
            environmentVariables.Add("Inkarr_Update_NewVersion", updateMessage.NewVersion.ToString());
            environmentVariables.Add("Inkarr_Update_PreviousVersion", updateMessage.PreviousVersion.ToString());
        ...
        public override ValidationResult Test()
        {
            ...
            if (failures.Empty())
            {
                ...
                {
                    var environmentVariables = new StringDictionary();
                    environmentVariables.Add("Inkarr_EventType", "Test");
