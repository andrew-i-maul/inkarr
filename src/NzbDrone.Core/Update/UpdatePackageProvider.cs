...
namespace NzbDrone.Core.Update
{
    ...
    public class UpdatePackageProvider : IUpdatePackageProvider
    {
        ...
        public UpdatePackageProvider(IHttpClient httpClient, IInkarrCloudRequestBuilder requestBuilder, IAnalyticsService analyticsService, IPlatformInfo platformInfo, IMainDatabase mainDatabase)
        {
