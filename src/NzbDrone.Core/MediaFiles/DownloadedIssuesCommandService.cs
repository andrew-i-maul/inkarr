        ...
        private List<ImportResult> ProcessPath(DownloadedIssuesScanCommand message)
        {
            ...
            if (message.DownloadClientId.IsNotNullOrWhiteSpace())
            {
                ...
                if (trackedDownload != null)
                {
                    ...
                    var importResults = _downloadedTracksImportService.ProcessPath(message.Path, message.ImportMode, trackedDownload.RemoteIssue.Volume, trackedDownload.DownloadItem);
