...
namespace NzbDrone.Core.Tags
{
    ...
    public class TagService : ITagService
    {
        ...
        public TagDetails Details(int tagId)
        {
            ...
            var volume = _volumeService.AllForTag(tagId);
            ...
            return new TagDetails
            {
                ...
                VolumeIds = volume.Select(c => c.Id).ToList(),
        ...
        public List<TagDetails> Details()
        {
            ...
            var volumes = _volumeService.GetAllVolumeTags();
            ...
            foreach (var tag in tags)
            {
                details.Add(new TagDetails
                {
                    ...
                    VolumeIds = volumes.Where(c => c.Value.Contains(tag.Id)).Select(c => c.Key).ToList(),
