...
namespace NzbDrone.Common.Instrumentation
{
    public static class NzbDroneLogger
    {
        ...
        {
            RegisterAppFile(appFolderInfo, "appFileInfo", "inkarr.txt", 5, LogLevel.Info);
            RegisterAppFile(appFolderInfo, "appFileDebug", "inkarr.debug.txt", 50, LogLevel.Off);
            RegisterAppFile(appFolderInfo, "appFileTrace", "inkarr.trace.txt", 50, LogLevel.Off);
        }
