...
namespace NzbDrone.Integration.Test.ApiTests
{
    ...
    public class NamingConfigFixture : IntegrationTest
    {
        ...
        public void should_be_able_to_update()
        {
            ...
            config.StandardIssueFormat = "{Volume Name} - {Issue Title}{ (PartNumber)}";
        ...
        [Test]
        public void should_get_bad_request_if_volume_folder_format_does_not_contain_volume_name()
        {
            var config = NamingConfig.GetSingle();
            config.RenameIssues = true;
            config.VolumeFolderFormat = "This and That";
