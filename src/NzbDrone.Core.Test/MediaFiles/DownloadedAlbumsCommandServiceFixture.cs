...
namespace NzbDrone.Core.Test.MediaFiles
{
    ...
    public class DownloadedIssuesCommandServiceFixture : FileSystemTest<DownloadedIssuesCommandService>
    {
        ...
        public void should_process_folder_with_downloadclientitem_if_available()
        {
            ...
            Mocker.GetMock<IDownloadedIssuesImportService>().Verify(c => c.ProcessPath(_downloadFolder, ImportMode.Auto, _trackedDownload.RemoteIssue.Volume, _trackedDownload.DownloadItem), Times.Once());
        }
