...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class QualityParserFixture : CoreTest
    {
        ...
        [TestCase("Volume Title - Issue Title 2017 REPACK FLAC aAF", true)]
        [TestCase("Volume Title - Issue Title 2017 RERIP FLAC aAF", true)]
        [TestCase("Volume Title - Issue Title 2017 PROPER FLAC aAF", false)]
