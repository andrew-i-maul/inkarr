...
namespace NzbDrone.Core.Test.MetadataSource
{
    ...
    public class MetadataRequestBuilderFixture : CoreTest<MetadataRequestBuilder>
    {
        ...
        public void Setup()
        {
            ...
            Mocker.GetMock<IInkarrCloudRequestBuilder>()
                .Setup(s => s.Metadata)
                .Returns(new HttpRequestBuilder("https://api.issueinfo.club/v1/{route}").CreateFactory());
        }
        ...
        public void should_use_default_if_config_blank()
        {
            ...
            details.BaseUrl.ToString().Should().Contain("issueinfo.club/v1");
        }
    }
}
