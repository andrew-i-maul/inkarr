...
namespace NzbDrone.Core.Test.DecisionEngineTests.RssSync
{
    ...
    public class DelaySpecificationFixture : CoreTest<DelaySpecification>
    {
        ...
        {
            _remoteIssue.ParsedIssueInfo.Quality = new QualityModel(Quality.MOBI);
        ...
        {
            _remoteIssue.Release.PublishDate = DateTime.UtcNow;
            _remoteIssue.ParsedIssueInfo.Quality = new QualityModel(Quality.MP3);
        ...
        [Test]
        public void should_be_true_when_release_is_a_proper_for_existing_issue()
        {
            _remoteIssue.ParsedIssueInfo.Quality = new QualityModel(Quality.MP3, new Revision(version: 2));
            _remoteIssue.Release.PublishDate = DateTime.UtcNow;
        ...
        [Test]
        public void should_be_true_when_release_is_a_real_for_existing_issue()
        {
            _remoteIssue.ParsedIssueInfo.Quality = new QualityModel(Quality.MP3, new Revision(real: 1));
            _remoteIssue.Release.PublishDate = DateTime.UtcNow;
        ...
        [Test]
        public void should_be_false_when_release_is_proper_for_existing_issue_of_different_quality()
        {
            _remoteIssue.ParsedIssueInfo.Quality = new QualityModel(Quality.AZW3, new Revision(version: 2));
            _remoteIssue.Release.PublishDate = DateTime.UtcNow;
