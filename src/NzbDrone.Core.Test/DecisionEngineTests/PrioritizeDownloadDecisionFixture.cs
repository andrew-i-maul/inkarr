...
namespace NzbDrone.Core.Test.DecisionEngineTests
{
    ...
    public class PrioritizeDownloadDecisionFixture : CoreTest<DownloadDecisionPriorizationService>
    {
        ...
        private RemoteIssue GivenRemoteIssue(List<Issue> issues, QualityModel quality, int age = 0, long size = 0, DownloadProtocol downloadProtocol = DownloadProtocol.Usenet, int indexerPriority = 25)
        {
            ...
            remoteIssue.Volume = Builder<Volume>.CreateNew()
        ...
        {
            var remoteIssue1 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3, new Revision(version: 1, real: 0)));
            var remoteIssue2 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3, new Revision(version: 1, real: 1)));
        ...
        {
            var remoteIssue1 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3, new Revision(version: 1)));
            var remoteIssue2 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3, new Revision(version: 2)));
        ...
        {
            var remoteIssue1 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3));
            var remoteIssue2 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3));
            ...
            var qualifiedReports = Subject.PrioritizeDecisions(decisions);
            qualifiedReports.First().RemoteIssue.ParsedIssueInfo.Quality.Quality.Should().Be(Quality.MP3);
        }

        [Test]
        public void should_order_by_age_then_largest_rounded_to_200mb()
        {
            var remoteIssueSd = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3), size: 100.Megabytes(), age: 1);
            var remoteIssueHdSmallOld = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3), size: 1200.Megabytes(), age: 1000);
            var remoteIssueSmallYoung = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3), size: 1250.Megabytes(), age: 10);
            var remoteIssueHdLargeYoung = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3), size: 3000.Megabytes(), age: 1);
        ...
        {
            var remoteIssue1 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3), age: 10);
            var remoteIssue2 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3), age: 5);
        ...
        [Test]
        public void should_not_throw_if_no_issues_are_found()
        {
            var remoteIssue1 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3), size: 500.Megabytes());
            var remoteIssue2 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3), size: 500.Megabytes());
        ...
        public void should_put_usenet_above_torrent_when_usenet_is_preferred()
        {
            ...
            var remoteIssue1 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3), downloadProtocol: DownloadProtocol.Torrent);
            var remoteIssue2 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3), downloadProtocol: DownloadProtocol.Usenet);
        ...
        [Test]
        public void should_prefer_discography_pack_above_single_issue()
        {
            var remoteIssue1 = GivenRemoteIssue(new List<Issue> { GivenIssue(1), GivenIssue(2) }, new QualityModel(Quality.FLAC));
            var remoteIssue2 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.FLAC));
        ...
        {
            var remoteIssue1 = GivenRemoteIssue(new List<Issue> { GivenIssue(1), GivenIssue(2) }, new QualityModel(Quality.MP3));
            var remoteIssue2 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.FLAC));
        ...
        [Test]
        public void should_prefer_single_issue_over_multi_issue()
        {
            var remoteIssue1 = GivenRemoteIssue(new List<Issue> { GivenIssue(1), GivenIssue(2) }, new QualityModel(Quality.MP3));
            var remoteIssue2 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3));
        ...
        {
            var remoteIssue1 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.MP3));
            var remoteIssue2 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.AZW3));
        ...
        {
            var remoteIssue1 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.FLAC));
            var remoteIssue2 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.FLAC));
        ...
        public void should_prefer_proper_over_score_when_download_propers_is_prefer_and_upgrade()
        {
            ...
            var remoteIssue1 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.FLAC, new Revision(1)));
            var remoteIssue2 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.FLAC, new Revision(2)));
        ...
        public void should_prefer_score_over_proper_when_download_propers_is_do_not_prefer()
        {
            ...
            var qualifiedReports = Subject.PrioritizeDecisions(decisions);
            qualifiedReports.First().RemoteIssue.ParsedIssueInfo.Quality.Quality.Should().Be(Quality.FLAC);
        ...
        {
            var remoteIssue1 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.AZW3, new Revision(1)), indexerPriority: 25);
            var remoteIssue2 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.AZW3, new Revision(1)), indexerPriority: 50);
            var remoteIssue3 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.AZW3, new Revision(1)), indexerPriority: 1);
        ...
        public void ensure_download_decisions_indexer_priority_is_not_perfered_over_quality()
        {
            ...
            var remoteIssue4 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.AZW3, new Revision(1)), indexerPriority: 25);
        ...
        public void should_prefer_score_over_real_when_download_propers_is_do_not_prefer()
        {
            ...
            var remoteIssue1 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.FLAC, new Revision(1, 0)));
            var remoteIssue2 = GivenRemoteIssue(new List<Issue> { GivenIssue(1) }, new QualityModel(Quality.FLAC, new Revision(1, 1)));
