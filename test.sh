...
FILES=( "Inkarr.Api.Test.dll" "Inkarr.Automation.Test.dll" "Inkarr.Common.Test.dll" "Inkarr.Core.Test.dll" "Inkarr.Host.Test.dll" "Inkarr.Integration.Test.dll" "Inkarr.Libraries.Test.dll" "Inkarr.Mono.Test.dll" "Inkarr.Update.Test.dll" "Inkarr.Windows.Test.dll" )
ASSMEBLIES=""
...
export INKARR_TESTS_LOG_OUTPUT="File"
