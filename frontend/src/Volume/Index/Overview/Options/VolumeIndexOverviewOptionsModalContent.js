...
class VolumeIndexOverviewOptionsModalContent extends Component {
  ...
  constructor(props, context) {
    ...
    this.state = {
      ...
      showLastIssue: props.showLastIssue,
      showAdded: props.showAdded,
      showIssueCount: props.showIssueCount,
  ...
  componentDidUpdate(prevProps) {
    ...
    if (showLastIssue !== prevProps.showLastIssue) {
      state.showLastIssue = showLastIssue;
    }
    ...
    if (showIssueCount !== prevProps.showIssueCount) {
      state.showIssueCount = showIssueCount;
    }
...
VolumeIndexOverviewOptionsModalContent.propTypes = {
  showTitle: PropTypes.string.isRequired,
  size: PropTypes.string.isRequired,
  detailedProgressBar: PropTypes.bool.isRequired,
  showMonitored: PropTypes.bool.isRequired,
  showQualityProfile: PropTypes.bool.isRequired,
  showLastIssue: PropTypes.bool.isRequired,
