...
import styles from './EditVolumeModalContent.css';

class EditVolumeModalContent extends Component {
...
EditVolumeModalContent.propTypes = {
  ...
  onDeleteVolumePress: PropTypes.func.isRequired
};
