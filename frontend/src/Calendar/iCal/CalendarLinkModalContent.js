...
function getUrls(state) {
  ...
  let icalUrl = `${window.location.host}${window.Inkarr.urlBase}/feed/v1/calendar/Inkarr.ics?`;
  ...
  icalUrl += `pastDays=${pastDays}&futureDays=${futureDays}&apikey=${encodeURIComponent(window.Inkarr.apiKey)}`;
