...
const fileNameTokens = [
  {
    token: '{Volume Name} - {Issue Title} - {Quality Full}',
    example: 'Volume Name - Issue Title - MP3 Proper'
  },
  {
    token: '{Volume.Name}.{Issue.Title}.{Quality.Full}',
    example: 'Volume.Name.Issue.Title.MP3'
  },
  {
    token: '{Volume Name} - {Issue Title}{ (PartNumber)}',
    example: 'Volume Name - Issue Title (2)'
  },
  {
    token: '{Volume Name} - {Issue Title}{ (PartNumber/PartCount)}',
    example: 'Volume Name - Issue Title (2/10)'
  }
];

const volumeTokens = [
  { token: '{Volume Name}', example: 'Volume\'s Name' },

  { token: '{Volume NameThe}', example: 'Volume\'s Name, The' },

  { token: '{Volume NameFirstCharacter}', example: 'A' },

  { token: '{Volume CleanName}', example: 'Volumes Name' },

  { token: '{Volume SortName}', example: 'Name, Volume' },
...
const originalTokens = [
  { token: '{Original Title}', example: 'Volume.Name.Issue.Name.2018.AZW3-EVOLVE' },
        ...
        <ModalContent onModalClose={onModalClose}>
          ...
          <ModalBody>
            ...
            <FieldSet legend={translate('Author')}>
              <div className={styles.groups}>
                {
                  volumeTokens.map(({ token, example }) => {
                    return (
                      <NamingOption
                        key={token}
                        name={name}
