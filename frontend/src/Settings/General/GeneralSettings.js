    ...
    return (
      <PageContent title={translate('GeneralSettings')}>
        ...
        <ConfirmModal
          ...
          message={
            `Inkarr requires a restart to apply changes, do you want to restart now? ${isWindowsService ? 'Depending which user is running the Inkarr service you may need to restart Inkarr as admin once before the service will start automatically.' : ''}`
          }
