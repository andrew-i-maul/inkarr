...
import styles from './IssueFileEditorTableContent.css';

class IssueFileEditorTableContent extends Component {
                    ...
                    items.map((item) => {
                      return (
                        <IssueFileEditorRow
                          ...
                          deleteIssueFile={dispatchDeleteIssueFile}
                        />
                      );
                    })
                  }
...
IssueFileEditorTableContent.propTypes = {
...
export default IssueFileEditorTableContent;
