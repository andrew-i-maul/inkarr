...
import IssueIndexPoster from './IssueIndexPoster';
import styles from './IssueIndexPosters.css';
...
class IssueIndexPosters extends Component {
  ...
  cellRenderer = ({ key, rowIndex, columnIndex, style }) => {
    ...
    const issueIdx = rowIndex * columnCount + columnIndex;
    const issue = items[issueIdx];
...
export default IssueIndexPosters;
