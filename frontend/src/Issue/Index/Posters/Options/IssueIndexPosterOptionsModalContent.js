...
class IssueIndexPosterOptionsModalContent extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (showVolume !== prevProps.showVolume) {
...
IssueIndexPosterOptionsModalContent.propTypes = {
...
export default IssueIndexPosterOptionsModalContent;
