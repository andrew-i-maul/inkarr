...
class Queue extends Component {
  ...
  render() {
    ...
    const isRefreshing = isFetching || isVolumeFetching || isIssuesFetching || isRefreshMonitoredDownloadsExecuting;
    const isAllPopulated = isPopulated && ((isVolumePopulated && isIssuesPopulated) || !items.length || items.every((e) => !e.issueId));
        ...
        <RemoveQueueItemModal
          ...
          canIgnore={isConfirmRemoveModalOpen && (
            selectedIds.every((id) => {
              ...
              return !!(item && item.volumeId && item.issueId);
            })
          )}
