...
import styles from './AddVolumeOptionsForm.css';

class AddVolumeOptionsForm extends Component {
      ...
      <Form {...otherProps}>
        <FormGroup>
          ...
          <FormInputGroup
            ...
            helpText={translate('AddNewVolumeRootFolderHelpText', { folder })}
...
AddVolumeOptionsForm.propTypes = {
...
AddVolumeOptionsForm.defaultProps = {
  includeSpecificIssueMonitor: false
};

export default AddVolumeOptionsForm;
